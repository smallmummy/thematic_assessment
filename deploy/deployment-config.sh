...
export AWS_ACCOUNT_ID="260242174813"  # Your AWS account ID (or leave empty to auto-detect)
...
export OPENAI_API_KEY_SECRET_ARN="arn:aws:secretsmanager:ap-southeast-2:260242174813:secret:thematic-assessment-openai-key-SxOKDV"
